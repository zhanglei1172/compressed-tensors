...
@TransformFactory.register("identity")
class IdentityFactory(HadamardFactory):
    """
    Factory used to apply identity transforms to a model
    ...
    def _create_weight(
        ...
        data = torch.eye(size, dtype=precision, device=device)
